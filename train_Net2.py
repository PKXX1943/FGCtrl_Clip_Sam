...
class MyDecoder(MaskDecoder):
    def __init__(self, model_type):
        ...
        self.coalescing_ratio = nn.Parameter(torch.zeros(256,256))
    ...
    def forward(
        ...
        final_mask = (1 - torch.abs(self.coalescing_ratio)) * masks_hq + torch.abs(self.coalescing_ratio) * extra_mask
